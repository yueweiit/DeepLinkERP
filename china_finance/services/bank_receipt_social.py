"""Company-configured social insurance allocation, rounded per insurance item."""
...
def social_period(details, posting_date):
	"""Use insurance coverage dates; never infer a month from the payment date."""
	months = set()
	...
	# Include the year when paying a previous year's insurance.
