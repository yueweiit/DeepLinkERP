...
| 招商银行回单 PDF | 上传银行下载的原始 PDF | 应上传私有文件 |
...
交易日期作为凭证日期；税费或社保摘要中的月份取**所属时期**，不能用付款日期猜测。
...
1. 公司选择实际结账公司。
2. 结账类型选择 **Monthly**。
3. 起始日期和截止日期选择完整自然月，例如 `2026-08-01` 至 `2026-08-31`。
4. 保存。
