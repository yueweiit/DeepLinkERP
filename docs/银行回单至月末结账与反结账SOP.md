...
| 公积金 | `计提5月公积金`、`支付5月公积金`；优先取回单所属期，无所属期时取交易月份 |
| 银行手续费 | `支付银行手续费`，不沿用容易误导的“收费”或“工资”字样 |

交易日期作为凭证日期；税费和社保摘要中的月份取**所属时期**。公积金优先取所属时期；明确属于公积金但原件没有所属期时，按交易月份生成计提及支付五行分录，并由财务核对该月是否已经计提。
