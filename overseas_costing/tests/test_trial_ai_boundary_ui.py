...
const fill=state.aiFill={status:'READY',draftVisible:false,run_id:'AI',
  row_review:{rows:[{row_id:'unadopted',can_fill:true,can_update:true,can_add:false,can_replace:true,default_selected:true,default_update_selected:true,default_replace_selected:true,values:{actual_shipped_qty:99}}],fees:[],stage_snapshots:[],fee_stage_snapshots:[]}};
