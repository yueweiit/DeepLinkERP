...
- 客户、供应商和银行对账快照；
- 招商银行、中国银行、农业银行、工商银行和广发银行文字版回单解析、历史凭证补回单、确认生成草稿、跨来源去重及按公司配置社保、公积金分摊；
...
银行回单入口、历史与新业务处理、悦为社保分摊规则及服务器更新步骤见[银行回单导入](docs/银行回单导入.md)。

草稿查改、未记账试算和按月统一记账见[凭证准备与月末记账操作](docs/凭证准备与月末记账操作.md)。
